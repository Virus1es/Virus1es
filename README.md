...
Как фронтенд-разработчик и владею: **JS, TS, React, Tailwind CSS, Next.js**. Имею опыт работы с различными наборами готовых компонентов для React(**Shadcn, HeroUI**), работал с **zod**.
