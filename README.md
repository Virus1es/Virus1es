...
Написать мне можно в **Telegram** или другие мессенджеры — ссылки на них есть в моем профиле.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Entity%20Framework-%23338fcc.svg?style=for-the-badge&logo=dotnet&logoColor=white" alt="Entity Framework" />  
</div>
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Microsoft%20SQL%20Server-CC2927?style=for-the-badge&logo=mssqlserver-white&logoColor=white" alt="SQL Server"/>
...
Как фронтенд-разработчик и владею: **JS, TS, React, Tailwind CSS**. Имею опыт работы с различными наборами готовых компонентов для React(**Shadcn, HeroUI**), работал с **zod**.
